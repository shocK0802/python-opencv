...
for i in range(0,51):   # Put the amount of pictures you have taken for the calibration inbetween range(0,?) wenn starting from the image number 0
    t= str(i)
...
#    ChessImaR= cv2.imread(path,0)
    ...
    ChessImaR= cv2.imread('SaveImage//'+'chessboard-R'+t+'.jpg',0)    # Right side
    ChessImaL= cv2.imread('SaveImage//'+'chessboard-L'+t+'.jpg',0)    # Left side
