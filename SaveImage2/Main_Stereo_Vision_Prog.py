...
for i in range(0,25):   # Put the amount of pictures you have taken for the calibration inbetween range(0,?) wenn starting from the image number 0
    t= str(i)
#    print('chessboard-R'+t+'.jpg')
#    imgRstr='chessboard-R'+t+'.jpg'
#    path = r'SaveImage\chessboard-R0.jpg'
#    ChessImaR= cv2.imread(path,0)
    
    ChessImaR= cv2.imread('SaveImage2//'+'chessboard-R'+t+'.jpg',0)    # Right side
    ChessImaL= cv2.imread('SaveImage2//'+'chessboard-L'+t+'.jpg',0)    # Left side
    retR, cornersR = cv2.findChessboardCorners(ChessImaR,
                                               (a,b),None)  # Define the number of chees corners we are looking for
